...
In the [previous tutorial](/start/proto-loader), we obtained `loader.js`, a module that handles the loading of proto files. In this tutorial, we will use this module to develop the server-side of our application. Let's get started!
