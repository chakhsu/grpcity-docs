...
<ref *1> Type {
  ...
  parent: <ref *2> Namespace {
    ...
    parent: Namespace {
      ...
      resolved: false,
      comment: null,
      filename: 'test_helloworld.proto',
      nested: [Object],
      _nestedArray: null,
      Greeter: [Service],
      Hellor: [Service]
    ...
    resolved: false,
    comment: null,
    filename: 'test_helloworld_model.proto',
    nested: { HelloRequest: [Circular *1], HelloReply: [Type] },
    _nestedArray: null,
    HelloRequest: [Circular *1],
    HelloReply: Type {
      options: undefined,
      parsedOptions: null,
      name: 'HelloReply',
