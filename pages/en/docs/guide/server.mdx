...
<Callout>
Detailed explanations of `channelOptions` can be found in the [Config Guide](/en/guide/config).
</Callout>

<Callout>
Detailed explanations of `credentials` can be found in the [Credentials Guide](/en/guide/credentials).
</Callout>
...
`server.use()` provides middleware capabilities for pre and post-processing of `implementation`. For more details, see the [Middleware Guide](/en/advanced/server-middleware).
