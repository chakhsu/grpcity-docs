...
The Project Link：https://github.com/chakhsu/grpcity-database-service
...
You don't need to write the code for `model`, `proto`, `handler`, and `test`. Simply execute the relevant code generation commands.
