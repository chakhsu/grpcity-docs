...
Here, we will demonstrate how to utilize the capability of `async stream`. It is recommended to first go through the [Stream](/en/guide/stream) guide, as there are some similarities between the two.
