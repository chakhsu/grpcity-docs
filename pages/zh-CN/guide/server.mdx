...
`channelOptions`在 [Config 指南](/zh-CN/guide/config) 里有详细讲解。
...
`gRPCity` Server 的特色功能，提供了`implementation` 前后处理的中间件能力，更多详情查看 [Middleware 指南](/zh-CN/guide/middleware)
...
另外，可以阅读 [Credentials 指南](/zh-CN/guide/credentials) 来获得更多信息。
