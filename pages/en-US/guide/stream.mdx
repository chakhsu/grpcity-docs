...
If you need to learn about working with `async streams`, you can refer to the [Stream v2](/en-US/guide/stream-v2) guide.
...
This demonstrates the use of different stream types between the client and server in gRPC.