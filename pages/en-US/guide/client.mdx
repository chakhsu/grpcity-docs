...
For an explanation of the `channelOptions` parameter, please refer to the [Config Guide](/en-US/guide/config). Here are some examples:
...
For more information on using streams, please refer to the [Stream](/en-US/guide/stream) and [Stream v2](/en-US/guide/stream-v2) guides.
